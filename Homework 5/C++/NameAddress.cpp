...
FullName NameAddress::getFullName() {
...
void NameAddress::setFullName(FullName input) {

	name = input;

}

Address NameAddress::getAddressObj() {
...
void NameAddress::setAddressObj(Address input) {
...
void NameAddress::setName(SingleName inputFirst, SingleName inputMiddle,
...
bool NameAddress::equals(NameAddress other) {
...
NameAddress NameAddress::constructor(NameAddress other) {

}

NameAddress NameAddress::copy(NameAddress other) {
